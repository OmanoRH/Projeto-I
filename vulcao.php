  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- Texto de introdução -->
        <p class="parag mb-3">Bolos com uma surpresa vulcânica em seu centro, levam ingredientes simples, majoritariamente chocolate <br> recomendado para festas de aniversário </p>
